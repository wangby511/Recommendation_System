...
from CollaborativeFiltering.collaborative_filtering import collaborative_filter_wrapper

INPUT_FILE_NAME = 'CollaborativeFiltering/popular_music_suprise_format.txt'
